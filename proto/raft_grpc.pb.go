...
//
// Defines the three RPCs node exchange
type RaftServiceClient interface {
	RequestVote(ctx context.Context, in *VoteRequest, opts ...grpc.CallOption) (*VoteResponse, error)
	PreVote(ctx context.Context, in *VoteRequest, opts ...grpc.CallOption) (*VoteResponse, error)
...
func (c *raftServiceClient) PreVote(ctx context.Context, in *VoteRequest, opts ...grpc.CallOption) (*VoteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VoteResponse)
...
type RaftServiceServer interface {
	...
	PreVote(context.Context, *VoteRequest) (*VoteResponse, error)
...
func (UnimplementedRaftServiceServer) PreVote(context.Context, *VoteRequest) (*VoteResponse, error) {
...
func _RaftService_PreVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServiceServer).PreVote(ctx, req.(*VoteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
